window.onload = () => {
    ...
    function actualizarTamaño() {
        ...
        posicionXRectangulo1 = gameAreaWidth * 0.03;  
        posicionXRectangulo2 = gameAreaWidth * 0.95;

        posicionYRectangulo1 = Math.min(posicionYRectangulo1, gameAreaHeight - rectanguloHeight);
        posicionYRectangulo2 = Math.min(posicionYRectangulo2, gameAreaHeight - rectanguloHeight);
    ...
    document.addEventListener("resize", actualizarTamaño);
